...
import { TrendingTokensFrameModal } from '@/Components/Frames/TrendingTokens';
...
export default function Leaderboard() {
  ...
  const createFrameButtonContent = (
    <div className="flex items-center gap-1 text-xs font-medium text-text-button">
      <svg
    ...
    <div className="content px-3 sm:px-0">
      <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-8 mb-8 sm:mb-12 pt-5 sm:pt-7">
        ...
        <div className="flex items-center gap-4 mt-1">
          ...
          <TrendingTokensFrameModal buttonContent={createFrameButtonContent} />
        </div>
      </div>
      {!isMobile && (
